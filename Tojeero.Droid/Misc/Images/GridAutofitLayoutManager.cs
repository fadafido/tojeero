...
namespace Tojeero.Droid.Images
{
	public class GridAutofitLayoutManager : GridLayoutManager
	{
		...
		public override void OnLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state)
		{
			...
			{
				int totalSpace;
				if (this.Orientation == OrientationHelper.Vertical)
				{
		...
		private int checkedColumnWidth(Context context, int columnWidth)
		{
			...
			columnWidth = (int)TypedValue.ApplyDimension(ComplexUnitType.Dip, columnWidth, context.Resources.DisplayMetrics);
			return columnWidth;
		}
